...
SWIGEXPORT void Init_ogr(void) {
  ...
  rb_define_module_function(mOgr, "ogr_get_driver_by_name", VALUEFUNC(_wrap_ogr_get_driver_by_name), -1);
  rb_define_module_function(mOgr, "ogr_get_driver", VALUEFUNC(_wrap_ogr_get_driver), -1);
